...
const Nuevacuenta = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string().required('La contraseña es obligatoria').min(6, 'Debe contener al menos 6 caracteres'),
    }),
    onSubmit: async (values) => {
      ...
      try {
        ...
        guardarMensaje('El usuario se registro exitosamente');
          ...
          <div className="w-full max-w-sm ">
            <form action="" className="bg-white rounded shadow-md px-8 pt-6 pb-8 mb-4" onSubmit={formik.handleSubmit}>
              <div className="mb-4">
                ...
                <input type="text" placeholder="Nombre usuario" id="nombre" value={formik.values.nombre}
              ...
              {/*<div className="mb-4">
                ...
                <input type="password" placeholder="Confirmar contraseña" id="passwordConfirmation"
                       className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
              </div>*/}
